    ...
    <div class="product-list">
        <div class="product">
            <a href="/product-1-url" title="Product 1">
                <img src="/images/product-placeholder.png" alt="Product 1" width="200"/>
            </a>
        ...
        <div class="product">
            <a href="/product-2-url" title="Product 2">
                <img src="/images/product-placeholder.png" alt="Product 2" width="200"/>
            </a>
        ...
        <div class="product">
            <a href="/product-3-url" title="Product 3">
                <img src="/images/product-placeholder.png" alt="Product 3" width="200"/>
            </a>
